...
@testset "cgFR" begin
    ...
    @test norm(∇f_global(cgFR(f_global,∇f_global, [1,2], updateα=Wolfe_Powell_rule, exportData = plotResults, fileName = "test"))) ≈ 0 atol=0.001
end
...
@testset "cgHS" begin
    ...
    @test norm(∇f_global(cgHS(f_global,∇f_global, [1,2], updateα=Wolfe_Powell_rule, exportData = plotResults, fileName = "test"))) ≈ 0 atol=0.001
end
...
@testset "cgPR" begin
    ...
    @test norm(∇f_global(cgPR(f_global,∇f_global, [1,2], updateα=Wolfe_Powell_rule, exportData = plotResults, fileName = "test"))) ≈ 0 atol=0.001
end
